...
2026-03-23 — Spec-v3 step 4 complete. Added protobuf recursion depth limit (MAX_PROTOBUF_DEPTH=64) to _convert_protobuf_value() in Google Gemini handler. Raises ConfigurationError if nesting depth exceeds limit, preventing stack exhaustion from malicious/malformed responses. All 2,518 tests pass.
